...
gameScene.create = function () {
  ...
  bg.setScale(2.9, 2.9);
  this.wheel = this.add.sprite(150, 180, 'wheel', {
    align: "center"
  });
...
gameScene.update = function () {
  if (this.input.activePointer.isDown) {
    if (this.canSpin) {
      this.text.setText("");
      var rounds = Phaser.Math.Between(2, 4); // then will rotate by a random number from 0 to 360 degrees. This is the actual spin
